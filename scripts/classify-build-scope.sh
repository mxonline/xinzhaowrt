...
while IFS= read -r path; do
  ...
  case "$path" in
    ...
    scripts/arthur-state-contract.ps1|scripts/arthur-evidence-index.ps1|scripts/arthur-state-consistency.ps1|\
    scripts/arthur-resume-state.ps1|scripts/arthur-operator-intent.ps1|scripts/arthur-firmware-event-ledger.ps1|\
    scripts/arthur-firmware-resume.ps1|scripts/arthur-git-remote.ps1|scripts/check-firmware-event-ledger-history.ps1|\
