...
Assert-Contains $deploy 'fetch-depth: 0' 'deployment checkout must be non-shallow so local persistent-runtime import can preserve commit history'
...
Write-Host 'HEADLESS_FULL_HISTORY_SYNC_CONTRACT=PASS'
