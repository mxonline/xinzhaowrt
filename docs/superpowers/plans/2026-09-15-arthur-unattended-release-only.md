...
- [x] Current migration PR relevant CI: Release Mode Contract, Production Agent CI, Resume State V2, Durable State Gate, Unified State Integration, Global Runtime Contract, Control Plane Gates, Codex Auto-Recovery CI, and Fast Preflight all PASS on the implementation head.

## Merge gate

Before integration:

- [x] Relevant CI is green.
